		...
		unsigned long flags)
{
    ...
    dev_info(dev, "Entering mem_hotplug code\n");
    ...
    dev_info(dev, "Entering ioremap code\n");
    ...
    dev_info(dev, "Entering struct page code\n");
    ...
    dev_info(dev, "Leaving devm_memremap_pages\n");
